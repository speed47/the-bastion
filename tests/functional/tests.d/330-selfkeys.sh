...
EOS
    ...
    configset ingressKeysFromAllowOverride true
    configset ingressKeysFrom "[\\\"0.0.0.0/0\\\",\\\"255.255.255.255\\\"]"
    ...
    configset ingressKeysFromAllowOverride false
